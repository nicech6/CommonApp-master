...
public class GradientTab extends View {
     ...
     * 图标渐变颜色
     */
    private static int DEFAULT_GRADIENT_COLOR = Color.BLACK;
    /**
     * tab普通状态时字体的颜色
     */
    private static int TEXT_COLOR_NORMAL = Color.GRAY;

    /**
     * tab选中时字体的颜色
     */
    private static int TEXT_COLOR_SELECTED = DEFAULT_GRADIENT_COLOR;
    ...
    public void setHighlightColor(int color) {
        this.DEFAULT_GRADIENT_COLOR = color;    // 图标高亮时的颜色
        this.TEXT_COLOR_SELECTED = color;        // 字体高亮时的颜色
        this.mTabGradientColor = color;
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mTabIconSelected == null) {    //只使用一张图片实现选项卡的普通和高亮两种状态
            ...
            if (alpha == 0) {
                ...
                canvas.drawColor(getResources().getColor(R.color.list_item_normal));
