...
public class ChangeCommonConnectUnitActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        Log.d(TAG, "onItemClick: " +stringExtra);
...
//        fragmentNow = mFragmentOne;
    ...
    private void showItemNameAndImages(int itemCount, TextView tv_item_name_1, TextView tv_item_name_2,
        ...
        if (itemCount == Const.COUNT_FIRST || itemCount == Const.COUNT_SECOND || itemCount == Const.COUNT_THIRD) {
            tv_rv_item_num_1.setVisibility(View.VISIBLE);
            tv_rv_item_num_2.setVisibility(View.VISIBLE);
            tv_rv_item_num_3.setVisibility(View.VISIBLE);
        ...
        switch (v.getId()) {
            ...
            case R.id.ll_item_tab_2:
                ...
                if (url_two.contains(IHttpService.CHECKING_CLOCK_URL)) {
                    Intent intent = new Intent(ChangeCommonConnectUnitActivity.this, FireInspectionActivity.class);
            ...
            case R.id.ll_item_tab_3:
                ...
                if (url_third.contains(IHttpService.FIRE_DECUMENT_MANAGE_URL)) {
                    Intent intent = new Intent(ChangeCommonConnectUnitActivity.this, DecumentManageActivity.class);
                    super.startActivity(intent);
                } else {
