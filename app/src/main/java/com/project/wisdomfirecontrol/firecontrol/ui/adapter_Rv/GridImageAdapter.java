...
public class GridImageAdapter extends
    ...
    private boolean isGoneOrVi = true;
    /**
     * 点击添加图片跳转
     */
...
//    }
    ...
    public GridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener, boolean isGoneOrVi) {
        this.context = context;
        this.isGoneOrVi = isGoneOrVi;
        mInflater = LayoutInflater.from(context);
        this.mOnAddPicClickListener = mOnAddPicClickListener;
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            if (isGoneOrVi) {
                viewHolder.mImg.setImageResource(R.drawable.icon_xiangce);
            }else {
