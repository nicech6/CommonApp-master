...
//    private int indicatorColor = Color.parseColor("#ffffff");//指示线的颜色  #0075E7
    private int indicatorColor = Color.BLUE;//指示线的颜色  #0075E7
    private int underlineColor = Color.WHITE;// 默认指示线的颜色
    private int dividerColor = Color.WHITE;// 分割线的颜色
    ...
    private int tabTextColor = Color.GRAY;// 标题未被选中时字体颜色
