...
public class Second_Web_Fragment extends BaseFragment {
    ...
    public void onStart() {
        super.onStart();
        Log.d(TAG, "onStart: 22" + Unit_CommonConnectUnitActivity.url_two);
        loadWebH5(Unit_CommonConnectUnitActivity.url_two);
    }
    ...
    public void setUserVisibleHint(boolean hidden) {
        ...
        Log.d(TAG, "setUserVisibleHint: " + Unit_CommonConnectUnitActivity.tempCount);
        if (hidden) {
