...
import com.project.wisdomfirecontrol.firecontrol.ui.view.dialog.OptAnimationLoader;

public class TPromptError extends Toast {
    ...
    public TPromptError(Context context) {
        super(context);
    ...
    protected void initView() {
        ...
        View view = inflater.inflate(R.layout.book_reading_toast_error, null);
