...
public class LoginChangeBean implements Serializable {
    ...
    private String msg;
    private LoginChangeDataBean data;
    ...
    public LoginChangeDataBean getData() {
        return data;
    }

    public void setData(LoginChangeDataBean data) {
        this.data = data;
    }
}
