...
public class SmokeDetectorFragment extends BaseFragment implements SettingOnlinePoliceContract.View {
    ...
    public void disposeSettingFragmentEvent(SettingFragmentEvent event) {
        switch (event.getWhat()) {
            case Constans.YANGANSUCESS://展示数据
                ...
                break;
            case Constans.YANGANERROR://展示数据
...
//        pid = "yun";
        ...
        if (presenter != null) {
            presenter.getSensor(pid, "烟感器", state, "ishave",Constans.YANGANSUCESS,Constans.YANGANERROR);
        }
    }
