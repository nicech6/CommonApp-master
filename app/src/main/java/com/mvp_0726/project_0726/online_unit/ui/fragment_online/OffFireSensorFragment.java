...
public class OffFireSensorFragment extends com.mvp_0726.common.base.codereview.BaseFragment implements SettingOnlinePoliceContract.View {
    ...
    public void disposeSettingFragmentEvent(SettingFragmentEvent event) {
        switch (event.getWhat()) {
            case Constans.MIEHUOSUCESS://展示数据
    ...
    private void getsensor(String state) {
        ...
        if (presenter != null) {
            presenter.getSensor(pid, "灭火器", state, "ishave", Constans.MIEHUOSUCESS, Constans.MIEHUOERROR);
        }
    }
