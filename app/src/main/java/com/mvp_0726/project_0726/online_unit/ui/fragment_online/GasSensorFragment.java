...
public class GasSensorFragment extends com.mvp_0726.common.base.codereview.BaseFragment implements SettingOnlinePoliceContract.View {
    ...
    private void getsensor(String state) {
        ...
        presenter.getSensor(pid, "气感", state, "ishave",Constans.QIGANSUCESS,Constans.QIGANERROR);
    }

    @Subscribe(threadMode = ThreadMode.MAIN)
    public void disposeSettingFragmentEvent(SettingFragmentEvent event) {
        switch (event.getWhat()) {
            case Constans.QIGANSUCESS://展示数据
