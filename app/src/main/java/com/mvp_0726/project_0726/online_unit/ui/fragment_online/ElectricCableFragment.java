...
public class ElectricCableFragment extends BaseFragment implements SettingOnlinePoliceContract.View {
    ...
    public void disposeSettingFragmentEvent(SettingFragmentEvent event) {
        switch (event.getWhat()) {
            case Constans.DIANQISUCESS://展示数据
                ...
                break;
            case Constans.DIANQIERROR://展示数据
    ...
    private void getsensor(String state) {
        ...
        if (presenter != null) {
            presenter.getSensor(pid, "电气火灾", state, "ishave", Constans.DIANQISUCESS,Constans.DIANQIERROR);
        }
    }
